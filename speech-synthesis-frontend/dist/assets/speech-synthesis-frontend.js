...
;define("speech-synthesis-frontend/services/audio-recorder", ["exports", "@ember/service", "@glimmer/tracking", "@ember/object", "@deepgram/sdk"], function (_exports, _service, _tracking, _object, _sdk) {
  "use strict";
  ...
  0; //eaimeta@70e063a35619d71f0,"@ember/service",0,"@glimmer/tracking",0,"@ember/object",0,"@deepgram/sdk"eaimeta@70e063a35619d71f
  function _initializerDefineProperty(e, i, r, l) { r && Object.defineProperty(e, i, { enumerable: r.enumerable, configurable: r.configurable, writable: r.writable, value: r.initializer ? r.initializer.call(l) : void 0 }); }
  function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
  function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
  function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
  ...
  let AudioRecorderService = _exports.default = (_class = class AudioRecorderService extends _service.default {
    constructor(...args) {
      ...
      _defineProperty(this, "gladiaSocket", void 0);
    }
    get transcription() {
    ...
    async initializeWebSocketGladia() {
      ...
      this.gladiaSocket.addEventListener("close", function ({
        code,
        reason
      }) {
        debugger;
